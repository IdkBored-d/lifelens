...
class EodPipelineService {
  ...
  Future<EodResult> runEndOfDay({required bool isOnline}) async {
    ...
    final todayMood = moodEntries.where((e) => e.date == dateStr).toList();
    ...
    final last7FitnessScores = await IsarService.instance
        .getLastNDaysFitnessScores(7);
    ...
    final trend = last7FitnessScores.length > 1
        ? (last7FitnessScores.first > last7FitnessScores.last
              ? 'upward'
              : 'downward')
        : 'stable';
