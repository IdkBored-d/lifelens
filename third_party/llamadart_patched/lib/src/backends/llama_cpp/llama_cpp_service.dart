...
class LlamaCppService {
  ...
  int loadModel(String modelPath, ModelParams modelParams) {
    ...
    // iOS simulator/device loads can fail when the GGUF is memory-mapped from
    // app-managed storage. Fall back to non-mmap loading on Apple mobile
    // platforms for better compatibility.
    mparams.use_mmap = !Platform.isIOS;
